...
import in.fortrainer.admin.activities.OrderDetailActivity;
...
public class OrderViewHolder extends RecyclerView.ViewHolder {
   ...
   // userId.setText(String.valueOf(order.getAppUser().getId()));
        llfirstHolder.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                //launchEventDetailsScreen();
                if(context!= null){
                    OrderDetailActivity.onOrderClicked(context,order);
                }
